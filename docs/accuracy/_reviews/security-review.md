...
| ------------------------------- | -------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------- |
| S-1                             | **med**  | Safety framing    | "Low reliability" must qualify event _attribution_, never suppress a real high/rising central trend; add edge-state test. |
