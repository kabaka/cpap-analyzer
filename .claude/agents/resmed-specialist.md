...
description: Domain expert on ResMed CPAP/APAP/BiPAP/VPAP/ASV machines, EDF/EDF+ data format and SD-card layout, and clinical CPAP metrics. Use for the data-import pipeline, machine-specific quirks, and clinical-rule questions.
skills:
  - plugin-architecture
---
...
- EDF files are untrusted binary input — coordinate with `security` (via the orchestrator) on safe parsing.
